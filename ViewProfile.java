...
/**
 * ViewProfile class.
 * Implements the View interface. Displays the user's information with their chirps under it.
 */
public class ViewProfile implements View
{
	//DATA MEMBERS
	String username;
	...
	public void displayChirps() 
	{
		...
		//Search for chirps needed by username and count number	
		{
